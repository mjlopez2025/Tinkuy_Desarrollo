...
$conn_wichi = new PDO(
    ...
    //Produccion: 172.16.1.58/Tincuy/consultas.php
    // Desarrollo: http://localhost:8080/Tinkuy/consultas/consultas.php

    define('BASE_URL', 'http://localhost:8080/Tinkuy/consultas/consultas.php');
?>
