...
try {
    ...
    $sql_query = "WITH sql_olap_ft AS ( SELECT ft_rendimiento.responsable_academica_id, ft_rendimiento.propuesta_formativa_id, ft_rendimiento.comision_id, ft_rendimiento.periodo_id, ft_rendimiento.docente_id, ft_rendimiento.actividad_id, ft_rendimiento.anio_academico, sum(ft_rendimiento.cantidad_registros_cursada) AS medida_cantidad_registros_cursada FROM (SELECT * FROM guarani3.ft_rendimiento ) ft_rendimiento WHERE true AND (ft_rendimiento.cantidad_registros_cursada is not null) GROUP BY ft_rendimiento.responsable_academica_id,ft_rendimiento.propuesta_formativa_id,ft_rendimiento.comision_id,ft_rendimiento.periodo_id,ft_rendimiento.docente_id,ft_rendimiento.actividad_id,ft_rendimiento.anio_academico ORDER BY ft_rendimiento.responsable_academica_id,ft_rendimiento.propuesta_formativa_id,ft_rendimiento.comision_id,ft_rendimiento.periodo_id,ft_rendimiento.docente_id,ft_rendimiento.actividad_id,ft_rendimiento.anio_academico ) SELECT d_responsable_academica.responsable_academica_desc, d_propuesta_formativa.propuesta_formativa_desc, d_comision.comision_desc, v_periodo_anio_academico_x_tipo_periodo.periodo_desc, d_docente.docente_desc, d_actividad.actividad_desc, d_anio.anio_id, sum(sql_olap_ft.medida_cantidad_registros_cursada) AS cantidad_registros_cursada FROM sql_olap_ft INNER JOIN guarani3.d_responsable_academica d_responsable_academica ON d_responsable_academica.responsable_academica_id = sql_olap_ft.responsable_academica_id INNER JOIN guarani3.d_propuesta_formativa d_propuesta_formativa ON d_propuesta_formativa.propuesta_formativa_id = sql_olap_ft.propuesta_formativa_id INNER JOIN guarani3.d_comision d_comision ON d_comision.comision_id = sql_olap_ft.comision_id INNER JOIN guarani3.v_periodo_anio_academico_x_tipo_periodo v_periodo_anio_academico_x_tipo_periodo ON v_periodo_anio_academico_x_tipo_periodo.periodo_id = sql_olap_ft.periodo_id INNER JOIN guarani3.d_docente d_docente ON d_docente.docente_id = sql_olap_ft.docente_id INNER JOIN guarani3.d_actividad d_actividad ON d_actividad.actividad_id = sql_olap_ft.actividad_id INNER JOIN public.d_anio d_anio ON d_anio.anio_id = sql_olap_ft.anio_academico GROUP BY d_responsable_academica.responsable_academica_desc,d_propuesta_formativa.propuesta_formativa_desc,d_comision.comision_desc,v_periodo_anio_academico_x_tipo_periodo.periodo_desc,d_docente.docente_desc,d_actividad.actividad_desc,d_anio.anio_id ORDER BY d_responsable_academica.responsable_academica_desc,d_propuesta_formativa.propuesta_formativa_desc,d_comision.comision_desc,v_periodo_anio_academico_x_tipo_periodo.periodo_desc,d_docente.docente_desc,d_actividad.actividad_desc,d_anio.anio_id";
